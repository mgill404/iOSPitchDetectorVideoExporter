...
#import "AEAudioController.h"
     ...
     */
    @interface SSEAudioFilePlayer : NSObject <AEAudioPlayable>
...
@property (nonatomic, assign) NSMutableArray *currentTimeArray;   //!< Current playback position, in seconds // NSTimeInterval
